...
struct AirdropRotation {
    min_new_holders: u32,
    #[serde(skip)] token_holder_counts: HashMap<String, u32>, // Simulated holder counts
}
...
impl Strategy for AirdropRotation {
    ...
    fn subscriptions(&self) -> HashSet<EventType> { [EventType::Social, EventType::Price].iter().cloned().collect() }
